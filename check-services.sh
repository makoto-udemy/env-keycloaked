...
check_http "[9] Frontend トップ"        "http://localhost:800/"
check_http "[10] Backend Swagger UI"     "http://localhost:800/api/docs"
check_http "[11] Keycloak トップ"        "http://localhost:800/auth/"

echo ""
echo -e "  ${BOLD}[ 直アクセス (内部サービス名) ]${RESET}"
check_http "[7] Frontend   :5173"       "http://frontend:5173/"
check_http "[8] Backend    :8000/docs"   "http://backend:8000/docs"
check_http "[6] Keycloak   :8080"       "http://keycloak:8080/auth/"
...
check_host "[1][5][9] Frontend トップ"        "http://localhost:10800/"
check_host "[1][5][10] Backend Swagger UI"     "http://localhost:10800/api/docs"
check_host "[1][5][11] Keycloak トップ"        "http://localhost:10800/auth/"

echo ""
echo -e "  ${BOLD}[ 直アクセス ]${RESET}"
check_host "[3][7] Frontend   :15173"       "http://localhost:15173/"
check_host "[4][8] Backend    :18000/docs"   "http://localhost:18000/docs"
check_host "[2][6] Keycloak   :18080"       "http://localhost:18080/auth/"
